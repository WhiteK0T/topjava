...
public class MealsUtil {
    ...
    public static List<MealTo> getAll(Collection<Meal> meals, int caloriesPerDay) {
    ...
    public static List<MealTo> filteredByPredicate(Collection<Meal> meals, int caloriesPerDay, Predicate<Meal> mealPredicate) {
